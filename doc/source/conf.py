...
# -*- coding: utf-8 -*-
#
# plato documentation build configuration file, created by
...
project = 'plato'
copyright = '2015-2018, The Regents of the University of Michigan'
...
latex_documents = [
  (master_doc, 'plato.tex', 'plato Documentation',
...
man_pages = [
    (master_doc, 'plato', 'plato Documentation',
     [author], 1)
]
